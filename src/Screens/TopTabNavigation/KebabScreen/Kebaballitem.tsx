    ...
    return (
        ...
        <View style={{ flex: 1, flexDirection: 'column', backgroundColor: 'white' }}>
            ...
            <View style={styles.flex1}>
                <Image
                    source={require('../../../Images/Bigkebeb.png')}
                />

                <View style={{ flexDirection: 'column', justifyContent: 'space-between' }}>
                    <Image
                        source={require('../../../Images/kebeb1.png')}
                    />
                    <Image
                        source={require('../../../Images/kebeb2.png')}
                        style={{ backgroundColor: 'white' }}
                    />
                    <Image
                        source={require('../../../Images/kebeb3.png')}
                    />


                    <Image
                        source={require('../../../Images/kebeb4.png')}
                    />
                </View>
            </View>

            <View style={styles.flex2}>
                <Text style={{ color: 'black', fontSize: 25, fontWeight: 'bold', padding: 10,fontFamily:'merriblack' }}>Mix of Beef,Chicken, </Text>
               
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', padding: 10, bottom: 15, }}>
                <Text style={{ color: 'black', fontSize: 25, fontWeight: 'bold', fontFamily:'merriblack' }}> Ribs,Potato </Text>
                ...
                <View style={{ bottom: 20, padding: 10, }}>
                    <Text style={{ fontSize: 12 ,fontFamily:'merriblack'}}>Beef, Chicken ,Aubergine , Potato  </Text>
                    <Text style={{ fontSize: 12,fontFamily:'merriblack' }}>Souce, Peper ,Mushroom   </Text>
                </View>

                <Text style={{ fontSize: 20, fontWeight: 'bold', padding: 10, bottom: 15 }}>$17.99</Text>
            </View>
