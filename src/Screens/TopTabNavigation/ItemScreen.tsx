        ...
        <View style={{ flex: 1, flexDirection: 'column', backgroundColor: 'white' }}>
            ...
            <View style={styles.flex1}>
                ...
                <View style={{ flexDirection: 'column', justifyContent: 'space-between' }}>
                    <Image
                        source={require('../../Images/Rectangle8.png')}
                    ...
                    <Image
                        source={require('../../Images/Rectangle10.png')}
                    />
                </View>
            </View>

            <View style={styles.flex2}>
                <Text style={{ color: 'black', fontSize: 25, fontWeight: 'bold', padding: 10,fontFamily:'merriblack' }}>Chese Burger </Text>

                <View style={{ flexDirection: 'row', justifyContent: 'space-between', padding: 10, bottom: 15 }}>
                    <Text style={{ color: 'black', fontSize: 25, fontWeight: 'bold',fontFamily:'merriblack' }}>Whopper</Text>
                ...
                <View style={{ bottom: 20, padding: 10, }}>
                    <Text style={{ fontSize: 12,fontFamily:'merriblack' }}>Ham, Cheddar ,Cheese , Onion ,Cornichon ,</Text>
                    <Text style={{ fontSize: 12,fontFamily:'merriblack' }}>Salad , Tomato</Text>
                </View>

                <Text style={{ fontSize: 20, fontWeight: 'bold', padding: 10, bottom: 15 }}>$8.99</Text>
            </View>
